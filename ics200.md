...
**2.3** In the **Create Integration - Select a Style/Pattern** popup, select the **Orchestration**
...
**2.17** Drag the **<\>echo** and drop on to **<\>return** 
...
**4.9** Fill your username and password
...
**6.8** Do the authentication call
